...
import { Plus, Calendar, Target, Edit2, Download, Trash2, Layers, RefreshCw } from 'lucide-react';
import { database, OverallPurpose, Segment } from '../utils/database';
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            title="データをCSVファイルでダウンロード"
          >
            <Download size={24} />
          </button>
          <Link to="/calendar" className="p-2 hover:bg-apple-gray-100 rounded-lg transition-colors">
            <Calendar size={24} />
          </Link>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-8 shadow-sm">
        <div className="flex justify-between items-start mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-apple-gray-700 text-white rounded-lg hover:bg-apple-gray-800 transition-colors"
          >
            <Plus size={16} />
            新しい領域を追加
          </button>
          ...
          <div className="mb-6 p-4 border rounded-lg">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-apple-gray-700 text-white rounded-lg hover:bg-apple-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                追加
              </button>
              <button
