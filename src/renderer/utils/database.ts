...
export const database = {
  ...
  async updateTodoAchievement(id: number, achievementLevel: string): Promise<void> {
    await db.updateTodoAchievement(id, achievementLevel);
  },

  async updateMilestoneAchievement(id: number, achievementLevel: string): Promise<void> {
  ...
  async deleteMilestone(milestoneId: number): Promise<void> {
    try {
      // Use generic query for milestone deletion (not yet implemented in main)
